          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="SaleAttr in spuSaleAttrList" :key="SaleAttr.id">
                ...
                v-for="attr in SaleAttr.spuSaleAttrValueList" :key="attr.id" @click="changeActive(attr,SaleAttr.spuSaleAttrValueList)">{{attr.saleAttrValueName}}</dd>
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" @change="changeText">
  ...
  export default {
    ...
    methods: {
      ...
      async addShopCard(){
        ...
        // dispatch本质上是在调用getCardList函数
        try {
          await this.$store.dispatch('getCardList',{skuId:this.$route.params.skuId,skuNum:this.skuNum});
